# Skeleton Code for Truth Table Printing

This is skeleton code to practice printing truth tables using boolean values. The code provided is for the following truth table depicting a tautology.
